...
class MoveItPickAndPlaceDemo:
    def __init__(self):
        ...
        box1_size = [0.01, 0.01, 0.1]
        box2_size = [0.02, 0.01, 0.15]
        ...
        box2_pose.pose.position.x = 0.43
        ...
        place_pose.pose.position.y = math.tan(-math.pi/6)*(0.3-0.1)+0.03
        place_pose.pose.position.z = table_ground + table_size[2] + target_size[2] / 2.0
        qte = quaternion_from_euler(0.0, 0.0, -math.pi/6)
        place_pose.pose.orientation.w = qte[3]
        place_pose.pose.orientation.x = qte[0]
        place_pose.pose.orientation.y = qte[1]
        place_pose.pose.orientation.z = qte[2]
    ...
    def make_grasps(self, initial_pose_stamped, allowed_touch_objects):
        ...
        g.post_grasp_retreat = self.make_gripper_translation(0.1, 0.15, [-0.5, 0.0, 1.0])
